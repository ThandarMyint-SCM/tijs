...
<?php include('../include/header.php'); ?>
  ...
  <div class="content">
    <div class="sec-theme-02">
      <h1 class="ttl ttl-level-04 ttl-theme-04 ttl-after-01 s-txt-center s-pt-60 s-pb-60">アクセス権限がありません。</h1>
      <div class="sec sec-min">
        <p class="s-fs-18 s-lh-18">ご指定のページ（URL）はアクセス権限がありません。<br>URLを今一度お確かめ頂くか、管理者にお問い合わせください。<br><br>エラーコード：403 Forbidden</p>
      </div>
    </div>
